                ...
                <div className="max-w-screen-2xl w-full mx-auto px-4 md:px-6">
                    <div className="flex justify-start">
                        <div className="flex items-center gap-3 tech-status-indicator">
                            ...
                            <div className="flex items-center gap-2 text-sm sm:text-base md:text-lg text-zinc-300 tracking-wide float-animation">
                ...
                <div className="flex flex-col justify-end min-h-[80vh]">
                    ...
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        ...
                        <div className="space-y-6 backdrop-blur-sm bg-black/20 p-6 rounded-2xl border border-white/10">
                            <h2
                                className="text-sm sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold max-w-[25ch] sm:max-w-[30ch] lg:max-w-[35ch] xl:max-w-[40ch] mx-auto
                            ...
                            {/* Subtitle */}
                            <p className="text-sm text-zinc-200/80 max-w-[45ch] mx-auto leading-relaxed font-medium backdrop-blur-sm">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5">
                            <button
                                className="px-2 py-1 sm:px-2.5 sm:py-1.5 md:px-2.5 md:py-1.5 lg:px-2.5 lg:py-1.5 xl:px-4 xl:py-2 
                                             ...
                                             flex items-center gap-1 tech-glow border border-sky-400/30"
                            >
                            ...
                            <button
                                className="px-2 py-1 sm:px-2.5 sm:py-1.5 md:px-2.5 md:py-1.5 lg:px-2.5 lg:py-1.5 xl:px-4 xl:py-2
                                         ...
                                         text-xs sm:text-xs md:text-xs lg:text-xs xl:text-sm
                                         flex items-center gap-1 hover:border-sky-300 hover:scale-105 tech-glow"
                                onClick={() => {
